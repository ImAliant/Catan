...
public class Home extends JFrame{
    ...
    private static JRadioButton human1, human2, human3, human4;
    ...
    public void homeDisplay(){
        ...
        JButton option =new JButton("Options joueurs");
        JButton exit =new JButton("Quitter");

        play.setPreferredSize(new Dimension(125,50));
        option.setPreferredSize(new Dimension(125,50));
        ...
        JRadioButton threePlayers =new JRadioButton("3 joueurs", true);
        JRadioButton fourPlayers =new JRadioButton("4 joueurs");
        ...
        human1 =new JRadioButton("Humain", true);
        JRadioButton ia1 =new JRadioButton("IA");
        bgJ1.add(human1);
        bgJ1.add(ia1);

        JLabel labelJ2 =new JLabel("Joueur 2");
        ButtonGroup bgJ2 =new ButtonGroup();
        human2 =new JRadioButton("Humain", true);
        JRadioButton ia2 =new JRadioButton("IA");
        bgJ2.add(human2);
        bgJ2.add(ia2);

        JLabel labelJ3 =new JLabel("Joueur 3");
        ButtonGroup bgJ3 =new ButtonGroup();
        human3 =new JRadioButton("Humain", true);
        JRadioButton ia3 =new JRadioButton("IA");
        bgJ3.add(human3);
        bgJ3.add(ia3);

        JLabel labelJ4 =new JLabel("Joueur 4");
        ButtonGroup bgJ4 =new ButtonGroup();
        human4 =new JRadioButton("Humain", true);
        JRadioButton ia4 =new JRadioButton("IA");
        bgJ4.add(human4);
        bgJ4.add(ia4);
    ...
    public static JRadioButton getHuman1() {return human1;}
    public static void setHuman1(JRadioButton human1) {Home.human1 = human1;}
    public static JRadioButton getHuman2() {return human2;}
    public static void setHuman2(JRadioButton human2) {Home.human2 = human2;}
    public static JRadioButton getHuman3() {return human3;}
    public static void setHuman3(JRadioButton human3) {Home.human3 = human3;}
    public static JRadioButton getHuman4() {return human4;}
    public static void setHuman4(JRadioButton human4) {Home.human4 = human4;}
}
